...
namespace Practice_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>{c.SwaggerDoc("v1", new OpenApiInfo {Title = "Practice_API", Version = "v1"});});
            services.AddDbContext<AnimalContext>(options =>
                options.UseMySQL(Configuration.GetConnectionString(  "AnimalConnectionMssql")));
        }
